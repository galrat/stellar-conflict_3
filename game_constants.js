...
const FACTIONS = [
  ...
  { id:'necrons', name:'Necrons', icon:'☥', color:'#00BCD4', homeTileId:'home_empire', flavor:'Dominate: Take any of your units from 1 world and place them on a friendly world containing a structure in the active system.', troops:{ground:5,space:0}, unitTiers:{ground:[0, 0, 0, 0, 1],space:[]}, structures:['factory'] },
  { id:'tyranids', name:'Tyranids', icon:'🧬', color:'#6A1B9A', homeTileId:'home_syndicate', flavor:'Dominate: Gain 1 additional asset token of your choice. You can have up to 4 of each asset token in your play area at any time.', troops:{ground:3,space:2}, unitTiers:{ground:[0, 0, 0],space:[0, 2]}, structures:['factory', 'bastion'] },
  { id:'tau', name:'Tau', icon:'⊕', color:'#00897B', homeTileId:'home_nomads', flavor:'Dominate: When you resolve a dominate order in a system containing at least 1 of your units or structures, you may draw 4 cards from the top of your event deck. Resolve the ability of 1 of those cards and discard the others.', troops:{ground:5,space:0}, unitTiers:{ground:[0, 0, 0, 1, 1],space:[]}, structures:['factory'] },
  { id:'imperial_guard', name:'Imperial Guard', icon:'⚜', color:'#795548', homeTileId:'home_elders', flavor:'Dominate: When you resolve a dominate order, you may resolve a deploy order, only to purchase 2 or more identical units and placing them on either 1 friendly world containing a structure or 1 friendly or uncontrolled void. Reduce the materiel cost of each unit by 1.', troops:{ground:5,space:1}, unitTiers:{ground:[0, 0, 0, 1, 1],space:[0]}, structures:['factory'] },
];
...
function makeState() {
  return {
    ...
    unitsPlaced: [],       // [{ key, area_place, unitId }]
    structsPlaced: [],     // [{ key, area_place, structId }]
    ...
    // ── warp storms ──────────────────────────
    warpStorms: [null, null],    // [{ tileKey: 'col,row', side: 'top'|'bottom'|'left'|'right' }] per player
