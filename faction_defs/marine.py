...
'''.split('\n'),
    ...
    battle_cards=[
        BattleCard(
            ...
            icons={"G": 1, "S": 0, "M": 0},
            primary="Gain 2 (g).",
            secondary={"requires": ["Scout", "Cruiser"],
                       "effect": "When enemy is routed this round, must spend [M] or be destroyed."},
            image="faction_defs/marine_data/battle/Ambush.jpg",
        ...
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Blessed Power Armour.jpg",
        ),
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Faith in the Emperor.jpg",
        ),
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Fury of the Ultramar.jpg",
        ),
        BattleCard(
            name="Reconnaissance",
            tier=-1,
            ...
            image="faction_defs/marine_data/battle/Reconnaissance.jpg",
        ),
        BattleCard(
            ...
            icons={"G": 1, "S": 1, "M": 0},
            primary="Gain 1 [?].",
            secondary={"requires": ["Marine"],
                       "effect": "Spend 1 [M] to take 1 scout or 1 marine from any world to this world."},
            image="faction_defs/marine_data/battle/Drop Pod Assault.jpg",
        ),
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Glory and Death.jpg",
        ),
        BattleCard(
            name="Hold the Line",
            tier=0,
            ...
            image="faction_defs/marine_data/battle/Hold the Line.jpg",
        ),
        BattleCard(
            name="Veteran Scouts",
            tier=0,
            ...
            image="faction_defs/marine_data/battle/Veteran Scouts.jpg",
        ),
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Armoured Advance.jpg",
        ),
        BattleCard(
            name="Break the Line",
            tier=2,
            ...
            image="faction_defs/marine_data/battle/Break the Line.jpg",
        ),
        BattleCard(
            name="Show No Fear",
            tier=2,
            ...
            image="faction_defs/marine_data/battle/Show No Fear.jpg",
        ),
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Emperor's Glory.jpg",
        ),
        BattleCard(
            ...
            image="faction_defs/marine_data/battle/Emperor's Might.jpg",
        ),
    ],
...
order_upgrades=[
        OrderUpgrade(
            ...
            tier=0,
            cost=1,
            primary="Orbital Strike, once per round. Gain [?].",
            secondary="Convert 1 [M] into [G].",
image = "faction_defs/marine_data/order/Reign of Fire.jpg",
        ),
        OrderUpgrade(
            name="Crusade",
            order_type="advance",
            tier=1,
            cost=2,
            primary="If no friendly worlds in system, gain 1 (R). Once per round.",
            secondary="Command Level 1.",
image = "faction_defs/marine_data/order/Crusade.jpg",
        ),
        OrderUpgrade(
            ...
            tier=1,
            cost=2,
            primary="May change 1 structure to a different structure. Once per round.",
            secondary="Command Level 1.",
image = "faction_defs/marine_data/order/Direct the Faithful.jpg",
        ),
        OrderUpgrade(
            ...
            tier=1,
            cost=2,
            primary="Treat Bastions as Factories, lower deployment limit by 1 each. Once per round.",
            secondary="Command Level 1.",
image = "faction_defs/marine_data/order/Recruitment Worlds.jpg",
        ),
        OrderUpgrade(
            name="Drop Pods",
            order_type="advance",
            ...
            secondary="Spend 2 [S] to place free Marine (may start combat). Command Level 2.",
image = "faction_defs/marine_data/order/Drop Pods.jpg",
        ),
    ],

event_cards=[
        EventCard(name="Adeptus Mechanicus",  warp_storm_move="Across",           card_type="Scheme", effect="At start of assess damage, discard to gain 2 (s), plus 1 (s) per (F) you have.",image = "faction_defs/marine_data/events/Adeptus Mechanicus.jpg"),
        EventCard(name="Emperor's Champion",  warp_storm_move="Sideways",         card_type="Scheme", effect="At start of assess damage, discard to rally 1 unit.",image = "faction_defs/marine_data/events/Emperor's Champion.jpg"),
        EventCard(name="Exterminatus",        warp_storm_move="Top Left/Bot Rgt", card_type="Scheme", effect="Before orbital strike, discard to convert all dice to [G].",image = "faction_defs/marine_data/events/Exterminatus.jpg"),
        EventCard(name="Heroic Intervention", warp_storm_move="Across",           card_type="Tactic", effect="Place free Marine on friendly structure or free Scout on any friendly world.",image = "faction_defs/marine_data/events/Heroic Intervention.jpg"),
        EventCard(name="Rites of Battle",     warp_storm_move="Top Left/Bot Rgt", card_type="Tactic", effect="Purchase 1 order upgrade, reduce by 1 materiel per Bastion.",image = "faction_defs/marine_data/events/Rites of Battle.jpg"),
        EventCard(name="The Emperor Protects",warp_storm_move="Sideways",         card_type="Tactic", effect="Place Bastion on friendly world. Free if no other structure there, otherwise cost 2 materiel.",image = "faction_defs/marine_data/events/The Emperor Protects.jpg"),
        EventCard(name="Unwavering Resolve",  warp_storm_move="Top Rgt/Bot Left", card_type="Scheme", effect="Instead of revealing an order, discard to rally all units in a system.",image = "faction_defs/marine_data/events/Unwavering Resolve.jpg"),
        EventCard(name="Work of the Righteous",warp_storm_move="Top Rgt/Bot Left",card_type="Tactic", effect="Gain assets or materiel from a friendly world.",image = "faction_defs/marine_data/events/Work of the Righteous.jpg"),
    ],
    extra = {
