...
'''.split('\n'),
    ...
    battle_cards=[
        ...
        BattleCard(
            ...
            secondary={"requires": ["Onslaught"], "effect": "Destroy 1 Onslaught to force enemy to choose & destroy one of his units."},
        ),
        BattleCard(
            name="Mek Boyz",
            tier=-1,
            ...
            icons={"G": 0, "S": 0, "M": 1},
            primary="Gain 1 [?].",
            secondary={"requires": ["Boyz", "Onslaught"], "effect": "Enemy discards top card of his combat deck.  You gain the cards combat icons until end of this execution round."},
        ),
        BattleCard(
            name="Shoota Boyz",
            tier=-1,
...
BattleCard(
    ...
    secondary={"requires": ["Wagon", "Kroozer"], "effect": "If you have more unrouted units, gain 2 (g) and 2 (s)."},
),
BattleCard(
    name="Rokkit Wagon",
    tier=2,
...
BattleCard(
    ...
    secondary={"requires": ["Boyz", "Onslaught"], "effect": "In this combat, each time enemy gets (g) or (s), you gain the same tokens as well."},
),
BattleCard(
    ...
    icons={"G": 2, "S": 3, "M": 0},
    primary="-",
    secondary={"requires": ["Gargant", "Kroozer"], "effect": "Choose enemy unit. Destroy unit unless enemy spends dice equal to its Tier."},
),
BattleCard(
    ...
    event_cards = [
        EventCard(name="Gitz Dem!",          warp_storm_move="Top Rgt/Bot Left", card_type="Scheme", effect="When an enemy unit routs in combat, discard to destroy that unit."),
        EventCard(name="How We Getz Here?",  warp_storm_move="Top Rgt/Bot Left", card_type="Tactic", effect="Take 1 unit from any world and place on any uncontrolled world."),
        EventCard(name="Letz Get Fightin'",  warp_storm_move="Across",           card_type="Tactic", effect="Either place 2 free Boyz on a world containing a Nob, or 1 free Boyz on a friendly world."),
        EventCard(name="Lootin' 'n Stealin'",warp_storm_move="Top Left/Bot Rgt", card_type="Tactic", effect="Gain 2 materiel. Choose a player to lose 1 asset of your choice."),
        EventCard(name="Moar Boyz!",         warp_storm_move="Sideways",         card_type="Tactic", effect="Gain 2 (R)."),
        EventCard(name="Mob Up!",            warp_storm_move="Sideways",         card_type="Scheme", effect="Instead of revealing Order, discard to resolve an Advance Order in a system with at least 2 of your own units."),
        EventCard(name="Teer it Down!",      warp_storm_move="Top Left/Bot Rgt", card_type="Scheme", effect="End of assess damage step in Ork combat, discard to destroy 1 structure on that world."),
        EventCard(name="Warboss",            warp_storm_move="Across",           card_type="Scheme", effect="When purchasing, reduce cost by 1 per (R) you have."),
    ],
    extra = {
        "homeworld":    "Гхазгхулл",
        "color_scheme": "#2E7D32",
