...
TYRANIDS = Faction(
    ...
    battle_cards=[
        BattleCard(
            ...
            cost=0,
            icons={"G": 0, "S": 1, "M": 0},
            primary="If attacking, gain 2 (g). If defending, either place 1 free (R) in this area or destroy 2 unrouted Gaunts to place 1 free bastion on this world if it does not already contain a structure.",
        ...
        BattleCard(
            ...
            icons={"G": 1, "S": 0, "M": 0},
            primary="-",
            secondary={"requires": ["Gaunt", "Devourer"],
                       "effect": "Force enemy to lose 1 [G], 1 [S], or 1 [M], whichever he has most of. If tied, you choose. Then gain 1 [G], 1 [S], or 1 [M], whichever your enemy lost."},
        ),
        BattleCard(
            name="Hive Tyrant",
            tier=-1,
            cost=0,
            icons={"G": 1, "S": 0, "M": 0},
            primary="Play 1 combat card from your hand. Do not resolve its abilities, but gain its combat icons during this combat.",
            secondary={"requires": ["Warrior", "Hive Ship"],
        ...
        BattleCard(
            ...
            cost=0,
            icons={"G": 0, "S": 1, "M": 0},
            primary="Destroy 1 unrouted Devourer in this system to place 1 free Warrior on",
            secondary={"requires": ["-"], "effect": "-"},
        ),
        BattleCard(
            name="Ripper Swarms",
            ...
            primary="Gain 2 (g).",
            secondary={"requires": ["Gaunt", "Devourer"],
                       "effect": "At the end of this execution round, gain 1 materiel for each unit destroyed during this execution round, to a maximum of 2."},
        ),
        BattleCard(
            ...
            cost=2,
            icons={"G": 1, "S": 1, "M": 0},
            primary="Either gain 1 (g) for each unrouted Gaunt or Devourer or place 1 free reinforcement token in this area. For each Gaunt of Devourer destroyed or routed this execution round, reduce damage you suffer in the next execution round by 1.",
            secondary={"requires": ["-"], "effect": "-"},
        ),
        BattleCard(
            name="Warrior Brood",
            ...
            cost=2,
            icons={"G": 1, "S": 1, "M": 0},
            primary="Destroy 1 of your unrouted units to gain 2 (s) and reduce the damage you suffer in the next execution round by 2.",
            secondary={"requires": ["Warrior", "Hive Ship"], "effect": "Reroll all of your [G], [S], or [M]."},
        ),
        BattleCard(
            name="Winged Horror",
            tier=0,
            cost=2,
            icons={"G": 2, "S": 0, "M": 0},
            primary="Destroy 1 of your unrouted units to gain 3 (g).",
            secondary={"requires": ["Warrior", "Devourer"],
        ...
        BattleCard(
            ...
            icons={"G": 1, "S": 2, "M": 0},
            primary="Destroy 1 of your unrouted units to gain 3 (g).",
            secondary={"requires": ["Carnifex", "Hive Ship"],
        ...
        BattleCard(
            ...
            cost=4,
            icons={"G": 2, "S": 1, "M": 0},
            primary="During this execution round, if enemy has to assign any damage, he assigns 3 additional damage.",
            secondary={"requires": ["Carnifex", "Hive Ship"],
        ...
        BattleCard(
            ...
            cost=4,
            icons={"G": 1, "S": 1, "M": 0},
            primary="Gain 1 [?]. Place 1 free (R) in this area.",
            secondary={"requires": ["Warrior", "Hive Ship"],
                       "effect": "Rally 1 of your units. Gain either 1 (g) or 1 (s) for each of your unrouted units in excess of the number of your enemys unrouted units."},
        ),
        BattleCard(
            ...
            cost=6,
            icons={"G": 3, "S": 1, "M": 0},
            primary="Spend any number of [M]. For each [M] you spend, gain either 1 [G] or 1 [S].",
            secondary={"requires": ["Bio-Titan", "Hive Ship"],
        ...
        BattleCard(
            ...
            cost=6,
            icons={"G": 1, "S": 2, "M": 0},
            primary="Destroy 1 of your unrouted units to gain either 3 (g) or 3 (s).",
            secondary={"requires": ["Bio-Titan", "Hive Ship"],
                       "effect": "Force your enemy to choose 3 times to either choose and rout 1 of his units or lose 1 die of his choice."},
        ),
    ] ,
    order_upgrades = [
        OrderUpgrade(
            ...
            secondary = "May spend up to 2 [G] to gain 1 (R) for each [G] you spend.",
        ),
        OrderUpgrade(
            ...
            tier       = 1,
            cost       = 2,
            primary   = "After you resolve this order, may purchase up to 2 units for each unrouted Hive Ship in the active system and place them on any friendly or unfriendly worlds in the active system. Once per round.",
        ...
        OrderUpgrade(
            ...
            tier       = 1,
            cost       = 2,
            primary   = "After you resolve this order, may destroy any of your units or structures on a world in the active system to temporarily gain materiel equal to their materiel cost. Use this materiel only to purchase ships in the active system. Once per round.",
            secondary = "Command Level 1.",
        ),
        OrderUpgrade(
            name       = "Without Number",
            ...
            tier       = 1,
            cost       = 2,
            primary   = "While resolving this order in a system in which you have an unrouted ship, you may place 1 free (R) in the contested area at the start of a reinforce step of combat. Once per round.",
            secondary = "Command Level 1.",
        ),
        OrderUpgrade(
            name       = "Mycetic Spores",
            ...
            tier       = 2,
            cost       = 3,
            primary   = "Orbital Strike, once per round. Requires Breeding Chambers. Bastions do not prevent orbital strike.",
            secondary = "Spend up to 2 [G] for each participating Hive Ship. For each [G] you spend, purchase 1 unit Tier 2 or less and place it on the world. Command Level 2.",
        ),
    ],
    event_cards = [
