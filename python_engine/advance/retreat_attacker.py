...
def retreat_attacker(state, player_id, retreat_tile_key, retreat_area_idx) -> dict:
    ...
    state.setdefault('log', []).append({
        'message': f'{loser_name} (нападавший) отступил в область {retreat_area_idx} ({len(loser_units)} юн.). Статус: разбит.',
        'player_id': player_id,
    })
